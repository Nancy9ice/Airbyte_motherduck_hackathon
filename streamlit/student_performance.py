...
def display_table_data(schema_name, table_name, table1_name):
    """
    ...
    try:
        ...
        df2 = query_table_to_df(conn, schema_name, table1_name)
...
display_table_data('exposures', 'waec_performance_metrics', 'sat_performance_metrics')